...
?>
    ...
    <div class="board-selector-container">
        <form method="get" action="<?= $this->url->dir() ?>" class="search">
            ...
            <div>
                <?= $this->form->text('task_id', array(), array(), array('placeholder="'.t('Search task id').'"', 'pattern="[0-9.]+" title="'.t('Task ID').'"'.'aria-label="'.t('Search task id').'"'.'style="border-radius: 3px; height: 16px;"'), 'input-addon-field') ?>
            </div>
        </form>
    </div>
